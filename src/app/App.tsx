...
export function App() {
  ...
  useEffect(() => {
    const onKey = (event: KeyboardEvent) => {
      ...
      if (event.ctrlKey && event.key.toLowerCase() === "z") { event.preventDefault(); useStudioStore.getState().undo(); }
      if (event.ctrlKey && event.key.toLowerCase() === "y") { event.preventDefault(); useStudioStore.getState().redo(); }
