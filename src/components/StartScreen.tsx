import { FileImage, FilePlus2, FolderInput, Gauge, Ruler } from "lucide-react";

export function StartScreen({ onNew, onOpen, onBatch }: { onNew: () => void; onOpen: () => void; onBatch: () => void }) {
  return <main className="start-screen">
    ...
    <section className="start-actions">
      ...
      <button onClick={onBatch}><FolderInput size={27} /><span><b>Procesar por lote</b><small>Elegir una carpeta de entrada y configurar la salida</small></span></button>
    </section>
